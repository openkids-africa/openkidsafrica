...
useHead({
  titleTemplate: (titleChunk) => {
    return `${titleChunk} | OpenKids Africa`;
  },
  title: metaTitle,
  meta: [
    {
    ...
    },
    {
      key: "og-url",
      property: "og:url",
      content: `https://openkidsafrica.netlify.app/`, // Update with OpenKids Africa's website URL
    },
    {
      key: "og-title",
      property: "og:title",
    ...
    },
    {
      key: "og-image",
      property: "og:image",
      content: `https://openkidsafrica.netlify.app/assets/images/photos/photo (4).jpg`, // Update with OpenKids Africa's image URL
    },
    //Twitter
    {
      key: "twitter-card",
